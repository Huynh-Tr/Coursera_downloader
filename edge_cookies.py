...
class EdgeCookieExtractor:
    ...
    def _get_edge_cookies_path(self):
        ...
        raise FileNotFoundError(
            "Edge cookies database not found. Set EDGE_PROFILE, or ensure Edge profile has cookies."
        )
    ...
    def _get_encryption_key(self):
        ...
        """
        try:
            with open(self.edge_key_path, encoding="utf-8") as f:
    ...
    def save_cookies_to_file(self, domain="coursera.org", filename="edge_cookies.txt"):
        ...
        with open(filename, "w") as f:
            ...
            for cookie in cookie_jar:
                ...
                line = f"{cookie.domain}\t{domain_flag}\t{cookie.path}\t{secure_flag}\t{expires}\t{cookie.name}\t{cookie.value}\n"
                f.write(line)
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Save to file
        filename = extractor.save_cookies_to_file(
            "coursera.org", "coursera_cookies.txt"
        )
