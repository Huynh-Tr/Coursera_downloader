...
OPENCOURSE_LIST_COURSES = (
    "https://api.coursera.org/api/courses.v1?q=watchlist&start={start}"
)
...
OPENCOURSE_PROGRAMMING_IMMEDIATE_INSTRUCTIOINS_URL = "https://api.coursera.org/api/onDemandProgrammingImmediateInstructions.v1/{course_id}~{element_id}"
...
AUTH_REDIRECT_URL = (
    "https://class.coursera.org/{class_name}"
...
POST_OPENCOURSE_ONDEMAND_EXAM_SESSIONS = (
    "https://api.coursera.org/api/onDemandExamSessions.v1"
)
...
OPENCOURSE_NOTEBOOK_DESCRIPTIONS = (
    "https://hub.coursera-notebooks.org/hub/coursera_login?token={authId}&next=/"
)
...
OPENCOURSE_NOTEBOOK_DOWNLOAD = (
    "https://hub.coursera-notebooks.org/user/{jupId}/files/{path}?download=1"
)
